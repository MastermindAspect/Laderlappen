...
// IMPORTANT: MODIFIED, NOT PART OF ORIGINAL LIBRARY
inline int NC (0);

// IMPORTANT: MODIFIED, NOT PART OF ORIGINAL LIBRARY
inline Encoder_port_type encoder_Port[6] =
{
  {NC, NC, NC, NC, NC},
  {19, 42, 11, 49, 48},
  {18, 43, 10, 47, 46},
 ...
 *   resetPos
 * \par Description
 *   Reset the internal encoder motor position counters.
 * \par Output
 *   None
 * \return
 *   None
 ...
 *   None
 */
void MeEncoderOnBoard::resetPos(void)
{
  encode_structure.currentPos = 0;
  encode_structure.targetPos = 0;
  encode_structure.previousPos = 0;
  encode_structure.pulsePos = 0;
  if (encode_structure.motionState == MOTION_WITHOUT_POS) {
    move(0);
  }
